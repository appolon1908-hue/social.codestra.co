...
import { ServiceAuthModule } from '@gitroom/nestjs-libraries/security/service-auth/service-auth.module';
  ...
  imports: [
    ...
    ThrottlerModule.forRoot({
      throttlers: [
        {
          ttl: 60000,
          limit: process.env.API_LIMIT ? Number(process.env.API_LIMIT) : 300,
        },
      ],
