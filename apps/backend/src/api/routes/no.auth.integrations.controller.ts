...
export class NoAuthIntegrationsController {
  ...
  async connectSocialMedia(
    ...
    if (webhookUrl) {
      // Legacy OAuth completion callbacks embedded organization credentials and
      // performed an unvalidated outbound request. Delivery now belongs to the
      // durable, signed webhook service; retain only one-time state cleanup.
