        ...
        <div className="flex flex-col flex-1">
          <div>
            <h1 className="text-[40px] font-[500] -tracking-[0.8px] text-start cursor-pointer">
              {t(
                'codestra_create_account_title',
                'Create your Codestra account'
              )}
            </h1>
            <p className="mt-3 text-sm leading-6 text-[#a1a1aa]">
              {t(
                'codestra_register_description',
                'Set up your organization and manage all your social channels from one place.'
              )}
            </p>
          </div>
              ...
              <div className={clsx('text-[12px]')}>
                ...
                process.env.NEXT_PUBLIC_PRIVACY_URL ? (
                  ...
                  <span className="text-[#a1a1aa]">
                    Codestra registration is invite-only while legal documents
