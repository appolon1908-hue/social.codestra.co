    ...
    <div className="flex flex-col gap-[16px] pt-[8px]">
      <p className="text-[14px] text-textColor/80">
        {t(
          ...
          'The Codestra browser extension is not installed. You need to install it before connecting this channel.'
        )}
      </p>
      <div className="flex gap-[10px]">
        <Button
          ...
          className="flex-1"
          onClick={() => {
            window.open('https://codestra.co', '_blank');
            modals.closeCurrent();
          }}
        >
  ...
  return (
    <div className="flex flex-col gap-[16px] pt-[8px]">
      ...
      <ul className="flex flex-col gap-[8px] list-disc ps-[20px] text-[14px] text-textColor/80">
        ...
        <li>
          Codestra does not take responsibility for any issues arising or
          ...
          try {
            ...
            toaster.show(
              t(
                ...
                'Codestra browser extension is not installed or not reachable.'
              ),
              'warning'
            );
            return;
