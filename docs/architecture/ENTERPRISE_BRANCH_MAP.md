...
|    11 | `billing/saas-subscriptions`        | Plan catalog, Stripe lifecycle, seats, usage and capability enforcement    |
|    12 | `feature/brand-intelligence`        | Brand profile, governed AI revisions, risk and evidence                    |
|    13 | `feature/approval-workflows`        | Staged approvals, separation of duties and immutable decisions             |
|    14 | `feature/campaign-command-center`   | Briefs, objectives, calendar and content dependencies                      |
|    15 | `feature/engagement-inbox`          | Normalized engagement, assignment, SLA and escalation                      |
|    16 | `feature/analytics-attribution`     | Normalized metrics, goals, attribution and reports                         |
|    17 | `portal/admin-client`               | Admin, operations, workspace and client portal navigation                  |
|    18 | `portal/external-review`            | Scoped, expiring reviewer experience                                       |
|    19 | `integration/enterprise-connectors` | Middleware contracts for Odoo, n8n, Klyrow and Telnexa                     |
|    20 | `ops/social-enterprise-release`     | E2E, accessibility, performance, backup, canary and rollback gates         |
