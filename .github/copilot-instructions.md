...
For backend and orchestrator work, follow
`docs/architecture/CODESTRA_SOCIAL_BACKEND_ARCHITECTURE_AND_DEVELOPMENT_RULES.md`.
It overrides conflicting instructions below. Changes branch from green `main`,
target `main`, remain contract-first and tenant-safe, use controlled forward
migrations, keep live capabilities disabled, and are never self-merged.

# Copilot Coding Agent Instructions for the upstream-derived application
